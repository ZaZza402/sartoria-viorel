...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="footer" style={{ backgroundColor: '#014421', color: '#ffffff' }}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="footer-title text-xl font-serif font-bold mb-4" style={{ color: '#ffffff' }}>
          ...
          <div>
            <h4 className="footer-heading text-lg font-semibold mb-4" style={{ color: '#ffffff' }}>
              Link Rapidi
            </h4>
        ...
        <div className="footer-divider mt-8 pt-8 text-center" style={{ borderTop: '1px solid rgba(255,255,255,0.2)' }}>
