...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "btn-primary bg-brand-primary text-brand-base hover:bg-brand-primary-hover border-2 border-brand-primary hover:border-brand-primary-hover",
    secondary: "btn-secondary bg-brand-accent text-brand-text hover:bg-brand-accent-dark border-2 border-brand-accent hover:border-brand-accent-dark",
    outline:
